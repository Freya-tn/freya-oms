...
import type { AbcRow, AbcTier } from "@/lib/insights/abc";

const percentFormatter = new Intl.NumberFormat("fr-FR", { style: "percent", maximumFractionDigits: 1 });

const TIER_LABEL: Record<AbcTier, string> = {
  A: "A : priorité haute",
  B: "B : priorité moyenne",
  C: "C : priorité basse",
};

const columns: GridColDef<AbcRow>[] = [
  {
    field: "tier",
    headerName: "Tier",
    width: 160,
    renderCell: (params) => {
      const tier = params.value as AbcTier;
      return (
        <Chip
